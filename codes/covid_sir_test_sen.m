...
writematrix(y,'solution_data_sen/data_senegal_r5_24days.xls')
writematrix(y_long,'solution_data_sen/data_senegal_r5_121days.xls')
...
%
   ...
   r_vacc = 0.0;
   mu_imm = 2.74e-3;
   beta_wos = 5/13.5; %(t<=30) + .3195/5.* (t>30);
   beta_ws =beta_wos/2;
   beta_h = beta_wos/10.;
   r_wos = 0.30;
   T_rwos = 14;
